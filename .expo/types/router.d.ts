...
declare module "expo-router" {
  ...
  // prettier-ignore
  type StaticRoutes = `/` | `/(tabs)/camera` | `/camera` | `/(tabs)/` | `/(tabs)` | `/(tabs)/settings` | `/settings` | `/+not-found` | `/food-detail` | `/food-list` | `/onboarding` | `/privacy-policy` | `/subscription` | `/home/project/hooks/useLanguage`;
  // prettier-ignore
